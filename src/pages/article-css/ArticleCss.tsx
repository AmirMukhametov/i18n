        ...
        <main className={styles.article}>
            ...
            <p>
                <FormattedMessage
                    ...
                    values={{ code: (chunks: React.ReactNode) => <code>{chunks}</code> }}
                />
            </p>
            ...
            <section className={styles.section}>
                ...
                <p>
                    <FormattedMessage
                        ...
                        defaultMessage={`Вот несколько преимуществ, которые дают логические свойства в контексте интернационализации: 
                        <ul>
                            <li>Универсальность: один набор стилей подходит для всех направлений письма.</li>
                            <li>Простота поддержки: меньше кода, меньше ошибок при внесении изменений.</li>
                            <li>Гибкость: легко добавлять новые языки, не меняя структуру стилей.</li>
                            <li>Последовательность: одинаковое визуальное поведение для всех пользователей, независимо от языка.</li>
                            <li>Актуальность: соответствие современным стандартам CSS и лучшим практикам UI-дизайна.</li>
                        </ul>`}
                        values={{
                            ul: (chunks: React.ReactNode) => <ul>{chunks}</ul>,
                            li: (chunks: React.ReactNode) => <li>{chunks}</li>,
                        }}
                        // Примечание: react-intl не парсит HTML внутри строк, поэтому лучше либо использовать компонент с dangerouslySetInnerHTML (если оправдано), либо хранить список как отдельный React-компонент.
                    />
                </p>
            </section>
